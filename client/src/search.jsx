    ...
    return(
        ...
        <Content style={mainStyle}>
         ...
         <img className="main-bg-img" src={blob2} /> 
          ...
          <form className="main-form" onSubmit={()=> props.clickSearch(whatToSearch.search)}>
            ...
            <Button onClick={()=> props.clickSearch(whatToSearch.search)} className="main-button" type="dashed">Search</Button>
          </form>
        </Content>
      </Layout>
    )
